...
const page = computed<CmsRecord | null>(() => {
  const record = butterPages.value?.history as CmsRecord | undefined
  return record ?? null
})
  ...
  meta: [
    {
      name: 'description',
      content:
        "beCamp is an implementation of barCamp, an anttendee planned unconference. Here's the story of how it came to be.",
      key: 'description',
    },
  ],
})
